...
public class CreateNoteCommand extends FrontCommand {
    ...
    public void send() throws ServletException, IOException {
        ...
        if (AppUtils.isParametersNull(response, "myNotes", title, text)) return;

        User user = AppUtils.getLoginUser(session);

        noteDAO.addNote(title, text, user.getId());
