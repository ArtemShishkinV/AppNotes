        ...
        <div class="block-inner">
            ...
            <div class="main-mynotes-list">
                <c:forEach var="note" items="${notes}">
                    <c:choose>
                        <c:when test="${note.isBlocked()}">
                            <div class="main-mynotes-item">
                                <div class="main-mynotes-item-title">${note.getTitle()} (Заблокирована)
                                </div>
                                <div class="main-mynotes-item-text">
                                        ${note.getText()}
                                </div>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div class="main-mynotes-item">
                                <div class="main-mynotes-item-title">${note.getTitle()}
                                    <a href="deleteNote?id=${note.getId()}">
                                ...
                                <div class="main-mynotes-item-footer">
                                    ...
                                    <a href="selectNote?id=${note.getId()}&back=${back}"
                                       class="main-mynotes-item-footer-item">
